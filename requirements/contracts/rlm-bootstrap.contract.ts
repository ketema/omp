...
export const RLM_BOOTSTRAP_CONTRACT = {
  ...
  'INV-BOOT-2': 'Kernel env carries exactly the bounded session set: RLM_DEPTH, RLM_MAX_DEPTH, RLM_SESSION_DIR, RLM_HARNESS_STATE_DIR, RLM_GLOBAL_HARNESS_STATE_DIR, OMP_RLM_AGENT_DIR, RLM_MAX_OUTPUT_CHARS, RLM_SNAPSHOT_MAX_BYTES, CCABDD_HARNESS, CCABDD_STATE_SERVER_PATH, HOME, PATH (F-206, A-011, SEQ-BOOT-2; the set MUST equal SAFE_SESSION_ENV_KEYS in the safety contract — SAFE-V1 validates it).',
