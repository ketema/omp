 ...
 * makes it unreachable in practice (issue #5973), and `ipython` is pinned
 * top-level, essential-mode native tool per REQ-RLM-0002 (FORBIDDEN-NATIVE-1:
 * never demoted to a discoverable-only `xd://` device) — each loses its
 * harness integration or usability if hidden behind dispatch.
 */
